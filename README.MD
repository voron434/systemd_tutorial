...
Однако, что если в `http.sever` или в самом `python-интерпретаторе` что-то поломается или просто произойдет какой-то сбой и из-за этого работа нашего файла остановится?
