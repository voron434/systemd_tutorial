...
Например, `http.sever` или сам `python-интерпретатор` может поломаться или просто произойдет какой-то сбой, и в итоге наш файл-инструкция `my_http_server` остановится.
